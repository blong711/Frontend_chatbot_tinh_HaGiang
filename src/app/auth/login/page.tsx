            ...
            <Form className="theme-form login-form">
              ...
              <FormGroup>
                ...
                <InputGroup>
                  ...
                  <input type="password" name="password" placeholder="Typing Password ..." className="block px-3 py-2 rounded-lg border border-gray-300" value={password} onChange={(e) => setPassword(e.target.value)}/>
